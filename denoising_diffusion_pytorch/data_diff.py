...
class EdgeDataset(data.Dataset):
    def __init__(
        ...
        # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        # self.debug_dir = "/home/chenhongyao/DiffusionEdge/output/test/"
...
# ！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
        ...
        #            os.path.join(self.debug_dir, f'transformed_img_{img_name}.png'))

        return {'image': edge_transformed, 'cond': img_transformed, 'img_name': img_name}
...
class EdgeDatasetTest(data.Dataset):
    ...
    def build_list(self):
        ...
        samples = [os.path.join(images_path, file) for file in os.listdir(images_path) if file.endswith(('png', 'jpg'))]  #.jpg linemod数据集用jpg    
        #print(samples)
