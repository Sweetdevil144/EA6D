...
#        print('time_all',end_time3-start_time)
    ...
    def load_pretrained(self, model, pretrained_dict_path=None):
        if pretrained_dict_path is None:
            print('No diffusion pretrained path provided, skipping load_pretrained')
            return model.state_dict()
        pretrained_dict = torch.load(pretrained_dict_path, map_location='cpu')['model']
